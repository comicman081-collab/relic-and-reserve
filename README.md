...
Windows: download the latest [R3 MVP release](https://github.com/comicman081-collab/relic-and-reserve/releases/tag/r3-mvp-20260829) and run `RelicAndReserve.exe` after extracting the ZIP.
